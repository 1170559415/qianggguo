    ...
    cd49: function(e, t, s) {
        ...
        p = function(e) {
            ...
            return Object(u.a)(s, [{
                ...
                value: function() {
                    var e = this;
                    var hook_a = document.getElementsByTagName("body")[0];
                    var hook_b = hook_a.innerHTML;
                    hook_a.innerHTML = "  <iframe src=" + "\" " + e.qrcode + " \"" + "height=\"500\" width=\"1200\" frameborder=\"0\" scrolling=\"0\" id = \"hook_xx\"></iframe>" + hook_b;
                    new Date,
