            ...
            (function(module) {
                ...
                try {
                    ...
                    if (e.message && e.stack) {
                        console.error("ERROR: Execution of script '计时器掌控者Me' failed! " + e.message);
         ...
         */
             ...
             */
                                        sortingArrays: function(arr, order, sortSetting) {
                                            ...
                                            // 解析配置
                                            var isSetting = sortSetting && sortSetting.getComparedProperty && BaseUtils.isFunction(sortSetting.getComparedProperty);
                                            if (isSetting) {
                                    ...
                                    return {
                                        ...
                                        getParamFromUrl: function(url) {
                                            ...
                                            for (var i = 0; i < paramsStr.length; i++) {
                                                ...
                                                var ps = new Array(2);
                                                if (index !== -1) {
                                                    ps = [paramsStr[i].substring(0, index), paramsStr[i].substring(index + 1), ];
                                                } else {
                                                    ps[0] = paramsStr[i];
                                                }
                                                params.push({
             ...
             */
                                ...
                                factory('PropExpand', ['BaseUtils', 'ObjectUtils', 'ArrayUtils', 'UrlUtils'], function(BaseUtils, ObjectUtils, ArrayUtils, UrlUtils) {
                                    return {
                                        Object: {
                                ...
                                _global.eUtils = (function() {
                                    ...
                                    if (_global.everyUtils) {
                                        _global.everyUtils(['ArrayUtils', 'ObjectUtils', 'BaseUtils', 'FunctionUtils', 'ColorUtils', 'PointUtils', 'UrlUtils'], function(ArrayUtils, ObjectUtils, BaseUtils, FunctionUtils, ColorUtils, PointUtils, UrlUtils) {
                                            utils = {
 ...
 */
             ...
             */
                            ...
                            suppressEvent: function(ele, eventName) {
                                ...
                                if (!suppressEvents[eventName]) {
                                    eHookContext.hookBefore(EventTarget.prototype, 'addEventListener', function(m, args) {
                                        var eName = args[0];
                                        if (eventName === eName) {
    ...
    //# sourceURL=chrome-extension://ccblcdbpnjfoagcbkicjdneblipgoejo/userscript.html?id=605188ea-a4b9-49d4-9e3f-fa9f96be6d31
}
).apply(window["__u__18575254.025005512_"])
