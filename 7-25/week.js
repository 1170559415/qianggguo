! function (e) {
    ...
    MImH: function (e, t, n) {
        ...
        function A(e, t) {
            return !t || "object" !== k(t) && "function" != typeof t ? D(e) : t
        }
        ...
        var _ = new O.a,
            R = function (e) {
                ...
                function s() {
                    ...
                    })), C(D(e), "onClickPre", (function () {
                        var t = e.state.curQuestionIndex;
                        t > 0 && e.setState({
                            curQuestionIndex: t - 1
                        }), Object(c.r)(E.a)
                    })), C(D(e), "onClickSubmit", P(regeneratorRuntime.mark((function t() {
                        var n, r, o, a, i, c;
                ...
                return t = s, (n = [{
                    key: "componentDidMount",
                    value: (a = P(regeneratorRuntime.mark((function e() {
                        var t, n, r, o, a = this;
                        return regeneratorRuntime.wrap((function (e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 8:
                                    e.prev = 8, e.t0 = e.catch(2), e.t0 && Object(h.a)({
                                        centered: !0,
                                        okText: "确定",
                                        title: "网络开小差~请稍后重试",
                                        onOk: function () {
                                ...
                                case 16:
                                    _.start(), r = o && o.name, this.uniqueId = o.uniqueId, this.setState({
                    ...
                    value: function () {
                        ...
                        return o.a.createElement(d.a, null, o.a.createElement(p.Helmet, null, o.a.createElement("title", null, s)), o.a.createElement("div", {
                            ...
                            navs: [y.b.HOME, y.b.MY_STUDY, y.b.EXAM_INDEX, y.b.EXAM_WEEKLY_INDEX, y.b.EXAM_DOING],
                            onLeave: function (t, n) {
                                x && !Object(c.n)() && (t.preventDefault(), Object(v.a)({
                            ...
                            spinning: O
                        }, o.a.createElement(b.a, I({
                            type: E.b.WEEKLY
                        }, l, h))), !l && k && o.a.createElement("div", {
                        ...
                        }, "完成")), k.answered && !1 === k.result && o.a.createElement(w.a, {
                            question: k
                        }))))
                    }
                }, {
        ...
        var z = function (e) {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    ...
                    var S = "",
                        P = "";
                    return O && u && "--" !== u && (P = "您的得分计入总积分"), 103 === g ? (S = "领取奖励已达今日上限", Object(x.m)("exam-paper-detail") && w("专项答题积分已达今日上限", 2e3)) : 102 === g && (S = "已领取积分"), S = P ? S ? s.a.createElement("div", {
                        style: {
                            textAlign: "center"
                        }
                    }, S, s.a.createElement("div", null, P)) : P : S, s.a.createElement("div", {
    ...
    eULb: function (e, t, n) {
        ...
        var P = function (e) {
            ...
            function a() {
                ...
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, a), S(k(e = o.call(this)), "initAudio", (function () {
                ...
                })), S(k(e), "playAudio", (function () {
                    e.audioEl.current.play()
                })), S(k(e), "pauseAudio", (function () {
                    e.audioEl.current.pause()
                })), S(k(e), "onChangePlay", (function (t) {
                    e.setState({
                        isPlay: t
                    })
                })), S(k(e), "onPlaying", (function () {
                    e.setState({
                        isReady: !0
                    })
                })), S(k(e), "onWaiting", (function () {
                    e.setState({
                        isReady: !1
                    })
                })), S(k(e), "onError", (function () {
                    e.state.isPlay && i.a.warning("播放失败，请重新进入答题"), e.resetAudio()
                })), S(k(e), "changePlay", Object(w.throttle)((function () {
                    e.state.isPlay ? e.pauseAudio() : e.playAudio()
                }), 500, {
                    trailing: !1
                })), S(k(e), "resetAudio", (function () {
                    e.audioEl.current.load(), e.setState({
                        isPlay: !1,
                        playTime: "00:00"
                    })
                })), S(k(e), "timeupdate", (function () {
                    var t = e.state,
                        n = t.duration,
                        r = t.playTime,
        ...
        var oe = function (e) {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    ...
                    var tt = this.props.question;
                        tt.correct.map((function (e) {
                            var qiangguodaan = e.value || e.label;
                            var daan = document.getElementsByClassName('title')[0];
                            var big = document.getElementsByClassName('big')[0];
                            if(big.innerHTML == "1"){
                    ...
                    return s.a.createElement("div", {
                        ...
                        className: "q-body"
                    }, this.getBody(n)), "AUDIO" === n.resourceType && s.a.createElement(P, {
    ...
    tDyU: function (e, t, n) {
        ...
        Object(y.b)() && (o.a.defaults.headers.common.Pragma = "no-cache"), S.interceptors.request.use((function (e) {
        ...
        function T() {
            return (T = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/pc/weekly/more", e.next = 3, S.get(P + "/api/exam/service/practice/pc/weekly/more", {
                                params: t
                            });
                        case 3:
        ...
        function D() {
            return (D = M(regeneratorRuntime.mark((function e() {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/statistic", e.next = 3, S.get(P + "/api/exam/service/practice/statistic");
                        case 3:
                            return t = e.sent, e.abrupt("return", t.data.data);
                        case 5:
                        case "end":
        ...
        function C() {
            return (C = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/answer/record/pc/list", e.next = 3, S.get(P + "/api/exam/service/answer/record/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function R() {
            return (R = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/solution", e.next = 3, S.get(P + "/api/exam/service/detail/solution", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function H() {
            return (H = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/queryV3", e.next = 3, S.get(P + "/api/exam/service/detail/queryV3", {
                                params: x(x({}, t), {}, {
                                    forced: !0
                                }),
                                examNet: !0
        ...
        function Z() {
            return (Z = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/save", e.next = 3, S.post(P + "/api/exam/service/detail/save", t);
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
                        case 5:
                        case "end":
        ...
        function G() {
            return (G = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/paper/pc/list", e.next = 3, S.get(P + "/api/exam/service/paper/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function F() {
            return (F = M(regeneratorRuntime.mark((function e() {
                var t;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/common/deduplicateRandomSearchV3", e.next = 3, S.get(P + "/api/exam/service/common/deduplicateRandomSearchV3", {
                                params: {
                                    limit: 5,
        ...
        function ee() {
            return (ee = M(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/score", e.next = 3, S.get(P + "/api/exam/service/detail/score", {
                                params: {
                                    queryTipScoreId: t
                                }
                            });
